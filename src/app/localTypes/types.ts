...
export enum FaultStatus {
  GIRIS_KONTROL_BEKLIYOR = 'GIRIS_KONTROL_BEKLIYOR',
  PROSES_BEKLIYOR = 'PROSES_BEKLIYOR',
  PROSES_ISLENIYOR = 'PROSES_ISLENIYOR',
  FINAL_KONTROL_BEKLIYOR = 'FINAL_KONTROL_BEKLIYOR',
  IRSALIYE_KESIMI_BEKLIYOR = 'IRSALIYE_KESIMI_BEKLIYOR',
