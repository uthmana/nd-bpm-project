...
export default function Fault(props: {
  ...
  const applications = [
    ...
    '2 - ND Patch',
    '1 - ND Microspheres TA 850',
    '1 - ND Microspheres TA 800',
    '1 - ND Microspheres TA 300',
    '1 - ND Microspheres 1193 S',
    '3 - ST-3 Thread Sealant',
    '4 - LM-1293 Maskeleme',
    '1 - Vibra-Tite VC-3',
    '5 - EZ-Drive 300 Lubricating',
    '5 - EZ-Drive 200 Lubricating',
    '7 - ND Strip',
  ];
  const standards = [
    'DIN 267-27',
